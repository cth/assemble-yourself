    ...
    en: {
      ...
      learn: {
        ...
        s4: { kicker: "reading the message", title: "Codons and the genetic code",
          ...
          tryLabel: "Try it — type a codon:", live: "(translated live)", notCodon: "not a codon", stop: "STOP" },
        ...
        s8: { kicker: "your tools", title: "How the board works",
          ...
          li4: "**Translation:** all six reading frames, computed for you. Find the **M … \\*** ORF and type the protein to win.",
      ...
      game: {
        ...
        tlSub: "Computed automatically from your consensus. Look for a run from a start **M** to a stop **\\*** (highlighted).",
  ...
  DICT.fr = {
    ...
    learn: {
      ...
      s4: { kicker: "lire le message", title: "Codons et code génétique",
        ...
        tryLabel: "Essayez — tapez un codon :", live: "(traduit en direct)", notCodon: "pas un codon", stop: "STOP" },
      ...
      s8: { kicker: "vos outils", title: "Comment fonctionne le plateau",
        ...
        li4: "**Traduction :** les six cadres de lecture, calculés pour vous. Trouvez l'ORF **M … \\*** et tapez la protéine pour gagner.",
    ...
    game: {
      ...
      tlSub: "Calculée automatiquement à partir de votre consensus. Cherchez une suite d'un start **M** à un stop **\\*** (surlignée).",
  ...
  DICT.es = {
    ...
    learn: {
      ...
      s4: { kicker: "leer el mensaje", title: "Codones y código genético",
        ...
        tryLabel: "Pruébalo — escribe un codón:", live: "(traducido en vivo)", notCodon: "no es un codón", stop: "STOP" },
      ...
      s8: { kicker: "tus herramientas", title: "Cómo funciona el tablero",
        ...
        li4: "**Traducción:** los seis marcos de lectura, calculados automáticamente. Encuentra el ORF **M … \\*** y escribe la proteína para ganar.",
    ...
    game: {
      ...
      tlSub: "Calculada automáticamente a partir de tu consenso. Busca una serie desde un inicio **M** hasta un stop **\\*** (resaltada).",
  ...
  DICT.da = {
    ...
    learn: {
      ...
      s4: { kicker: "at læse budskabet", title: "Kodoner og den genetiske kode",
        ...
        tryLabel: "Prøv det — skriv et kodon:", live: "(oversat live)", notCodon: "ikke et kodon", stop: "STOP" },
      ...
      s8: { kicker: "dine værktøjer", title: "Sådan virker brættet",
        ...
        li4: "**Oversættelse:** alle seks læserammer, beregnet automatisk. Find **M … \\***-ORF'en og skriv proteinet for at vinde.",
    ...
    game: {
      ...
      tlSub: "Beregnet automatisk ud fra din konsensus. Kig efter en række fra et start-**M** til et stop-**\\*** (fremhævet).",
  ...
  DICT.de = {
    ...
    learn: {
      ...
      s4: { kicker: "die Botschaft lesen", title: "Codons und der genetische Code",
        ...
        tryLabel: "Probier's — tippe ein Codon:", live: "(live übersetzt)", notCodon: "kein Codon", stop: "STOPP" },
      ...
      s8: { kicker: "deine Werkzeuge", title: "So funktioniert das Brett",
        ...
        li4: "**Übersetzung:** alle sechs Leserahmen, automatisch berechnet. Finde den **M … \\***-ORF und tippe das Protein, um zu gewinnen.",
    ...
    game: {
      ...
      tlSub: "Automatisch aus deinem Konsens berechnet. Suche eine Folge von einem Start-**M** zu einem Stopp-**\\*** (hervorgehoben).",
  ...
  DICT.it = {
    ...
    learn: {
      ...
      s4: { kicker: "leggere il messaggio", title: "Codoni e codice genetico",
        ...
        tryLabel: "Prova — digita un codone:", live: "(tradotto in tempo reale)", notCodon: "non è un codone", stop: "STOP" },
      ...
      s8: { kicker: "i tuoi strumenti", title: "Come funziona il tabellone",
        ...
        li4: "**Traduzione:** tutti e sei i moduli di lettura, calcolati automaticamente. Trova l'ORF **M … \\*** e digita la proteina per vincere.",
    ...
    game: {
      ...
      tlSub: "Calcolata automaticamente dal tuo consenso. Cerca una sequenza da un inizio **M** a uno stop **\\*** (evidenziata).",
